---
title: "PP-Stichprobenvergleiche (d = 0.92) für n = 100"
...
> **"PP_5.5"** besteht aus je 5 Messzeitpunkten im Pre- und im Post-Intervall. Dies sind die ursprünglich simulierten Fragebogen-Daten von N = 100 Personen (ursprünglich N = 100.000).  

> **"PP_30.30"** besteht aus je 30 Messzeitpunkten im Pre- und im Post-Intervall. Diese wurden aus den ursprünglichen Simulationsdaten erweitert und umfassen dieselben N = 100 Personen.  

> **"PP_1.1"** besteht jeweils aus dem 1. Messzeitpunkt im Pre- und im Post-Intervall für jede einzelne Person (N = 100).  

```{r setup, message = FALSE,	warning = FALSE, include = FALSE}
knitr::opts_chunk$set(echo = TRUE)

# für Umwandlung RMD -> R Script:
#knitr::purl("C:/Users/steph/OneDrive/Desktop/Psychologie/Masterstudium Psychologie/3. Semester/1. Master-Konversatorium/Preprocessing und Berechnungen/PP_Stichprobenvergleiche_d0.91_n100.Rmd", output = "PP_Stichprobenvergleiche_d0.91_n100.R", documentation = 2)
...
rand = sample(PP_5.5$ID, size = 100)
...
```{r remedy04, message=FALSE, warning=FALSE, eval=FALSE}
...
save(PP_5.5_ts, file = "Time Series Dataframes/k20_PP_5.5_n100_ts.RData")

###

load("Time Series Dataframes/k20_PP_5.5_n100_ts.RData")
...
ggsave("Time Series Dataframes/k20_PP_5.5_n100_Pre-Post_Box_Violin.jpg", plot = Pre_Post_Box_Violin, width = 6, height = 4)
save(Pre_Post_Box_Violin, file = "Time Series Dataframes/k20_PP_5.5_n100_Pre_Post_Box_Violin.RData")
...
ggsave("Time Series Dataframes/k20_PP_5.5_n100_Pre-Post_Box_Violin_Mean+CI.jpg", plot = Pre_Post_Box_Violin_Mean_CI, width = 6, height = 4)
save(Pre_Post_Box_Violin_Mean_CI, file = "Time Series Dataframes/k20_PP_5.5_n100_Pre_Post_Box_Violin_Mean_CI.RData")
```

```{r remedy06, fig.align="center", out.width="75%"}
#knitr::include_graphics("Time Series Dataframes/k20_PP_5.5_n100_Pre-Post_Box_Violin.jpg")
knitr::include_graphics("Time Series Dataframes/k20_PP_5.5_n100_Pre-Post_Box_Violin_Mean+CI.jpg")
```
...
```{r remedy08, message=FALSE, warning=FALSE, eval=FALSE}
...
save(PP_30.30_ts, file = "Time Series Dataframes/k20_PP_30.30_n100_ts.RData")

###

load("Time Series Dataframes/k20_PP_30.30_n100_ts.RData")
...
ggsave("Time Series Dataframes/k20_PP_30.30_n100_Pre-Post_Box_Violin.jpg", plot = Pre_Post_Box_Violin, width = 6, height = 4)
save(Pre_Post_Box_Violin, file = "Time Series Dataframes/k20_PP_30.30_n100_Pre_Post_Box_Violin.RData")
...
ggsave("Time Series Dataframes/k20_PP_30.30_n100_Pre-Post_Box_Violin_Mean+CI.jpg", plot = Pre_Post_Box_Violin_Mean_CI, width = 6, height = 4)
save(Pre_Post_Box_Violin_Mean_CI, file = "Time Series Dataframes/k20_PP_30.30_n100_Pre_Post_Box_Violin_Mean_CI.RData")
```

```{r remedy10, fig.align="center", out.width="75%"}
#knitr::include_graphics("Time Series Dataframes/k20_PP_30.30_n100_Pre-Post_Box_Violin.jpg")
knitr::include_graphics("Time Series Dataframes/k20_PP_30.30_n100_Pre-Post_Box_Violin_Mean+CI.jpg")
```
...
```{r remedy12, message=FALSE, warning=FALSE, eval=FALSE}
...
save(PP_1.1_ts, file = "Time Series Dataframes/k20_PP_1.1_n100_ts.RData")

###

load("Time Series Dataframes/k20_PP_1.1_n100_ts.RData")
...
ggsave("Time Series Dataframes/k20_PP_1.1_n100_Pre-Post_Box_Violin.jpg", plot = Pre_Post_Box_Violin, width = 6, height = 4)
save(Pre_Post_Box_Violin, file = "Time Series Dataframes/k20_PP_1.1_n100_Pre_Post_Box_Violin.RData")
...
ggsave("Time Series Dataframes/k20_PP_1.1_n100_Pre-Post_Box_Violin_Mean+CI.jpg", plot = Pre_Post_Box_Violin_Mean_CI, width = 6, height = 4)
save(Pre_Post_Box_Violin_Mean_CI, file = "Time Series Dataframes/k20_PP_1.1_n100_Pre_Post_Box_Violin_Mean_CI.RData")
```

```{r remedy14, fig.align="center", out.width="75%"}
#knitr::include_graphics("Time Series Dataframes/k20_PP_1.1_n100_Pre-Post_Box_Violin.jpg")
knitr::include_graphics("Time Series Dataframes/k20_PP_1.1_n100_Pre-Post_Box_Violin_Mean+CI.jpg")
```
...
```{r remedy16, message=FALSE, warning=FALSE, fig.align="center", out.width="75%"}
...
```{r remedy18, fig.show="hold", message=FALSE, warning=FALSE, out.width="50%"}
# Overlap-Plots zum Vergleich
...
```{r remedy22, fig.show="hold", out.width="50%"}
...
```{r remedy26, fig.align="center", message=FALSE, warning=FALSE, out.width="75%"}
...
```{r remedy32, message=FALSE, warning=FALSE, fig.align="center", out.width="75%"}
...
```{r remedy34, message=FALSE, warning=FALSE, fig.align = "center", out.width="50%"}
...
```{r remedy35, fig.show="hold", out.width="50%"}
...
```{r remedy42, fig.align="center", out.width="75%"}
...
```{r remedy43, fig.show="hold", out.width=c("50%","50%")}
...
```{r remedy50, message=FALSE, warning=FALSE, out.width="50%", fig.align="center"}
...
```{r remedy63, fig.align="center", message=FALSE, warning=FALSE}
# PRE
x = PP_5.5 %>% 
...
```{r remedy64, message=FALSE, warning=FALSE}
...
```{r remedy67, fig.align="center", message=FALSE, warning=FALSE}
### Cohen´s Kappa
Agreement = matrix(ncol = 15, nrow = 15, dimnames = list(rnames, rnames))
...
```{r remedy69, fig.show="hold", out.width="50%"}
...
```{r remedy70, fig.show="hold", out.width="50%"}
...
save(PP_5.5_Mean_PC_JK, file = "Jackknife/PP_5.5_Mean_PC_JK_k20_n100.RData")
...
PP_30.30_Mean_PC_JK = PP_30.30 %>% 
  select(ID, Mean_PC_jse, Mean_PC_jbias)
save(PP_30.30_Mean_PC_JK, file = "Jackknife/PP_30.30_Mean_PC_JK_k20_n100.RData")
```

```{r remedy72, message=FALSE, warning=FALSE, fig.align="center", out.width="75%"}
load("Jackknife/PP_5.5_Mean_PC_JK_k20_n100.RData")
load("Jackknife/PP_30.30_Mean_PC_JK_k20_n100.RData")
...
save(PP_5.5_RCI_ind_preSD_JK, file = "Jackknife/PP_5.5_RCI_ind_preSD_JK_k20_n100.RData")
...
PP_30.30_RCI_ind_preSD_JK = PP_30.30 %>% 
  select(ID, RCI_ind_preSD_jse, RCI_ind_preSD_jbias)
save(PP_30.30_RCI_ind_preSD_JK, file = "Jackknife/PP_30.30_RCI_ind_preSD_JK_k20_n100.RData")
```

```{r remedy74, message=FALSE, warning=FALSE, fig.align="center", out.width="75%"}
load("Jackknife/PP_5.5_RCI_ind_preSD_JK_k20_n100.RData")
load("Jackknife/PP_30.30_RCI_ind_preSD_JK_k20_n100.RData")
...
save(PP_5.5_RCI_ind_pooledSD_JK, file = "Jackknife/PP_5.5_RCI_ind_pooledSD_JK_k20_n100.RData")
...
PP_30.30_RCI_ind_pooledSD_JK = PP_30.30 %>% 
  select(ID, RCI_ind_pooledSD_jse, RCI_ind_pooledSD_jbias)
save(PP_30.30_RCI_ind_pooledSD_JK, file = "Jackknife/PP_30.30_RCI_ind_pooledSD_JK_k20_n100.RData")
```

```{r remedy76, message=FALSE, warning=FALSE, fig.align="center", out.width="75%"}
load("Jackknife/PP_5.5_RCI_ind_pooledSD_JK_k20_n100.RData")
load("Jackknife/PP_30.30_RCI_ind_pooledSD_JK_k20_n100.RData")
