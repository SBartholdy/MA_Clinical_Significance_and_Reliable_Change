#' ---
#' title: "PP-Stichprobenvergleiche (d = 0.92)"
...
#knitr::purl("C:/Users/steph/OneDrive/Desktop/Psychologie/Masterstudium Psychologie/3. Semester/1. Master-Konversatorium/Preprocessing und Berechnungen/PP_Stichprobenvergleiche_d0.91.Rmd", output = "PP_Stichprobenvergleiche_d0.91.R", documentation = 2)
...
#pacman::p_load(plyr, dplyr, tidyverse, bootstrap, sjmisc, lattice, Rmisc, devtools, psych, DescTools, summarytools, kableExtra, lubridate, timetk, overlapping, ggplot2, gghalves, plot.matrix, suddengains)
...
#'
## ----remedy03, message=FALSE, warning=FALSE--------------------------------------------------------------------------------------------------
...
#'
## ----remedy05, fig.align="center", out.width="75%"-------------------------------------------------------------------------------------------
...
#' > Pre-Post-Verläufe für 9 zufällig gezogene Personen
#'
## ----remedy07, message=FALSE, warning=FALSE--------------------------------------------------------------------------------------------------
...
#'
## ----remedy09, fig.align="center", out.width="75%"-------------------------------------------------------------------------------------------
...
#' > Pre-Post-Verläufe für 9 zufällig gezogene Personen
#'
## ----remedy11, message=FALSE, warning=FALSE--------------------------------------------------------------------------------------------------
...
#'
## ----remedy13, fig.align="center", out.width="75%"-------------------------------------------------------------------------------------------
...
#'
## ----remedy15, message=FALSE, warning=FALSE, fig.align="center", out.width="75%"-------------------------------------------------------------
...
#'
## ----remedy16, fig.show="hold", message=FALSE, warning=FALSE, out.width="50%"----------------------------------------------------------------
...
#'
## ----remedy17, fig.show="hold", message=FALSE, warning=FALSE, out.width="50%"----------------------------------------------------------------
# Overlap-Plots zum Vergleich
...
#'
## ----remedy21, fig.show="hold", out.width="50%"----------------------------------------------------------------------------------------------
...
#'
## ----remedy22, fig.show="hold", message=FALSE, warning=FALSE, out.width="50%"----------------------------------------------------------------
# Overlap-Plots zum Vergleich
...
#' <br>
#'
## ----remedy23, fig.show="hold", message=FALSE, warning=FALSE, out.width="50%"----------------------------------------------------------------
...
#'
## ----remedy24, fig.show="hold", message=FALSE, warning=FALSE, out.width="50%"----------------------------------------------------------------
...
#' <br>
#'
## ----remedy25, fig.align="center", message=FALSE, warning=FALSE, out.width="75%"-------------------------------------------------------------
...
#' ### PP_5.5
#'
## ----remedy27, fig.align="center", message=FALSE, warning=FALSE, out.width="75%"-------------------------------------------------------------
...
#' ### PP_30.30
#'
## ----remedy28, fig.align="center", message=FALSE, warning=FALSE, out.width="75%"-------------------------------------------------------------
...
#' ### PP_1.1
#'
## ----remedy29, fig.align="center", message=FALSE, warning=FALSE, out.width="75%"-------------------------------------------------------------
...
#' ### PP_5.5
#'
## ----remedy31, message=FALSE, warning=FALSE, fig.align="center", out.width="75%"-------------------------------------------------------------
...
#' ### PP_30.30
#'
## ----remedy32, message=FALSE, warning=FALSE, fig.align = "center", out.width="50%"-----------------------------------------------------------
...
#' ### PP_1.1
#'
## ----remedy33, message=FALSE, warning=FALSE, fig.align = "center", out.width="50%"-----------------------------------------------------------
...
#'
## ----remedy34, fig.show="hold", out.width="50%"----------------------------------------------------------------------------------------------
...
#' > PP_5.5
#'
## ----remedy38, fig.align="center", out.width="75%"-------------------------------------------------------------------------------------------
...
#' > PP_30.30
#'
## ----remedy39, fig.align="center", out.width="75%"-------------------------------------------------------------------------------------------
...
#' > PP_5.5
#'
## ----remedy40, fig.align="center", out.width="75%"-------------------------------------------------------------------------------------------
...
#' > PP_30.30
#'
## ----remedy41, fig.align="center", out.width="75%"-------------------------------------------------------------------------------------------
...
#'
## ----remedy42, fig.show="hold", out.width=c("50%","50%")-------------------------------------------------------------------------------------
...
#'
## ----remedy44, message=FALSE, warning=FALSE, out.width="50%", fig.align="center"-------------------------------------------------------------
...
#'
## ----remedy45, message=FALSE, warning=FALSE, out.width="50%", fig.align="center"-------------------------------------------------------------
...
#'
## ----remedy46, message=FALSE, warning=FALSE, out.width="50%", fig.align="center"-------------------------------------------------------------
...
#'
## ----remedy47, message=FALSE, warning=FALSE, out.width="50%", fig.align="center"-------------------------------------------------------------
...
#'
## ----remedy48, message=FALSE, warning=FALSE, out.width="50%", fig.align="center"-------------------------------------------------------------
...
#' > PP_1.1: RCI(JT)
#'
## ----remedy49, message=FALSE, warning=FALSE, out.width="50%", fig.align="center"-------------------------------------------------------------
...
#'
## ----remedy51, message=FALSE, warning=FALSE, out.width="50%", fig.align="center"-------------------------------------------------------------
...
#'
## ----remedy52, message=FALSE, warning=FALSE, out.width="50%", fig.align="center"-------------------------------------------------------------
...
#'
## ----remedy53, message=FALSE, warning=FALSE, out.width="50%", fig.align="center"-------------------------------------------------------------
...
#' ### CSI in PP_5.5
#'
## ----remedy55, message=FALSE, warning=FALSE, out.width="50%", fig.align="center"-------------------------------------------------------------
...
#' ### CSI in PP_30.30
#'
## ----remedy56, message=FALSE, warning=FALSE, out.width="50%", fig.align="center"-------------------------------------------------------------
...
#' ### CSI in PP_1.1
#'
## ----remedy57, message=FALSE, warning=FALSE, out.width="50%", fig.align="center"-------------------------------------------------------------
...
#'
## ----remedy59, message=FALSE, warning=FALSE, out.width="50%", fig.align="center"-------------------------------------------------------------
...
#'
## ----remedy60, message=FALSE, warning=FALSE, out.width="50%", fig.align="center"-------------------------------------------------------------
...
#'
## ----remedy62, fig.align="center", message=FALSE, warning=FALSE------------------------------------------------------------------------------
# PRE
x = PP_5.5 %>%
...
#'
## ----remedy63, message=FALSE, warning=FALSE--------------------------------------------------------------------------------------------------
...
#'
## ----remedy64, fig.align="center", message=FALSE, warning=FALSE------------------------------------------------------------------------------
### Cohen´s Kappa
...
#'
## ----remedy65, fig.align="center", message=FALSE, warning=FALSE------------------------------------------------------------------------------
### Cohen´s Kappa
Agreement = matrix(ncol = 15, nrow = 15, dimnames = list(rnames, rnames))
...
#'
## ----remedy66, fig.align="center", message=FALSE, warning=FALSE------------------------------------------------------------------------------
### Cohen´s Kappa
Agreement = matrix(ncol = 15, nrow = 15, dimnames = list(rnames, rnames))
...
#'
## ----remedy67, fig.show="hold", out.width="50%"----------------------------------------------------------------------------------------------
...
#'
## ----remedy68, fig.show="hold", out.width="50%"----------------------------------------------------------------------------------------------
...
#'
## ----remedy69, fig.show="hold", out.width="50%"----------------------------------------------------------------------------------------------
...
#'
## ----remedy71, message=FALSE, warning=FALSE, fig.align="center", out.width="75%"-------------------------------------------------------------
...
temp %>%
  ggplot(aes(x = Jackknife_SE, fill = Datasets)) +
    geom_histogram(alpha = 0.2, binwidth = 1, position = "identity") +
    labs(title = "Jackknife SEs", x = "Mean_PC_jse")
...
temp %>%
  ggplot(aes(x = Jackknife_Bias, fill = Datasets)) +
    geom_histogram(alpha = 0.2, binwidth = 1, position = "identity") +
    labs(title = "Jackknife Biases", x = "Mean_PC_jbias")
...
#'
## ----remedy73, message=FALSE, warning=FALSE, fig.align="center", out.width="75%"-------------------------------------------------------------
...
temp %>%
  ggplot(aes(x = Jackknife_SE, fill = Datasets)) +
    geom_histogram(alpha = 0.2, binwidth = 1, position = "identity") +
    labs(title = "Jackknife SEs", x = "RCI_ind_preSD_jse")
...
temp %>%
  ggplot(aes(x = Jackknife_Bias, fill = Datasets)) +
    geom_histogram(alpha = 0.2, binwidth = 1, position = "identity") +
    labs(title = "Jackknife Biases", x = "RCI_ind_preSD_jbias")
...
#'
## ----remedy75, message=FALSE, warning=FALSE, fig.align="center", out.width="75%"-------------------------------------------------------------
...
temp %>%
  ggplot(aes(x = Jackknife_SE, fill = Datasets)) +
    geom_histogram(alpha = 0.2, binwidth = 1, position = "identity") +
    labs(title = "Jackknife SEs", x = "RCI_ind_pooledSD_jse")
...
temp %>%
  ggplot(aes(x = Jackknife_Bias, fill = Datasets)) +
    geom_histogram(alpha = 0.2, binwidth = 1, position = "identity") +
    labs(title = "Jackknife Biases", x = "RCI_ind_pooledSD_jbias")
