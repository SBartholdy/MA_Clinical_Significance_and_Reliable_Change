---
title: "PP-Stichprobenvergleiche (d = 0.92) für n = 50"
...
> **"PP_5.5"** besteht aus je 5 Messzeitpunkten im Pre- und im Post-Intervall. Dies sind die ursprünglich simulierten Fragebogen-Daten von N = 50 Personen (ursprünglich N = 100.000).  

> **"PP_30.30"** besteht aus je 30 Messzeitpunkten im Pre- und im Post-Intervall. Diese wurden aus den ursprünglichen Simulationsdaten erweitert und umfassen dieselben N = 50 Personen.  

> **"PP_1.1"** besteht jeweils aus dem 1. Messzeitpunkt im Pre- und im Post-Intervall für jede einzelne Person (N = 50).  

```{r setup, message = FALSE,	warning = FALSE, include = FALSE}
knitr::opts_chunk$set(echo = TRUE)

# für Umwandlung RMD -> R Script:
#knitr::purl("C:/Users/steph/OneDrive/Desktop/Psychologie/Masterstudium Psychologie/3. Semester/1. Master-Konversatorium/Preprocessing und Berechnungen/PP_Stichprobenvergleiche_d0.91_n50.Rmd", output = "PP_Stichprobenvergleiche_d0.91_n50.R", documentation = 2)
...
## Drawing a Random Sample of n = 50

```{r remedy02}
# or with slice_sample(n = 50)
rand = sample(PP_5.5$ID, size = 50)
...
save(PP_5.5_ts, file = "Time Series Dataframes/k20_PP_5.5_n50_ts.RData")

###

load("Time Series Dataframes/k20_PP_5.5_n50_ts.RData")
...
ggsave("Time Series Dataframes/k20_PP_5.5_n50_Pre-Post_Box_Violin.jpg", plot = Pre_Post_Box_Violin, width = 6, height = 4)
save(Pre_Post_Box_Violin, file = "Time Series Dataframes/k20_PP_5.5_n50_Pre_Post_Box_Violin.RData")
...
ggsave("Time Series Dataframes/k20_PP_5.5_n50_Pre-Post_Box_Violin_Mean+CI.jpg", plot = Pre_Post_Box_Violin_Mean_CI, width = 6, height = 4)
save(Pre_Post_Box_Violin_Mean_CI, file = "Time Series Dataframes/k20_PP_5.5_n50_Pre_Post_Box_Violin_Mean_CI.RData")
```

```{r remedy06, fig.align="center", out.width="75%"}
#knitr::include_graphics("Time Series Dataframes/k20_PP_5.5_n50_Pre-Post_Box_Violin.jpg")
knitr::include_graphics("Time Series Dataframes/k20_PP_5.5_n50_Pre-Post_Box_Violin_Mean+CI.jpg")
```
...
save(PP_30.30_ts, file = "Time Series Dataframes/k20_PP_30.30_n50_ts.RData")

###

load("Time Series Dataframes/k20_PP_30.30_n50_ts.RData")
...
ggsave("Time Series Dataframes/k20_PP_30.30_n50_Pre-Post_Box_Violin.jpg", plot = Pre_Post_Box_Violin, width = 6, height = 4)
save(Pre_Post_Box_Violin, file = "Time Series Dataframes/k20_PP_30.30_n50_Pre_Post_Box_Violin.RData")
...
ggsave("Time Series Dataframes/k20_PP_30.30_n50_Pre-Post_Box_Violin_Mean+CI.jpg", plot = Pre_Post_Box_Violin_Mean_CI, width = 6, height = 4)
save(Pre_Post_Box_Violin_Mean_CI, file = "Time Series Dataframes/k20_PP_30.30_n50_Pre_Post_Box_Violin_Mean_CI.RData")
```

```{r remedy10, fig.align="center", out.width="75%"}
#knitr::include_graphics("Time Series Dataframes/k20_PP_30.30_n50_Pre-Post_Box_Violin.jpg")
knitr::include_graphics("Time Series Dataframes/k20_PP_30.30_n50_Pre-Post_Box_Violin_Mean+CI.jpg")
```
...
PP_1.1_ts = PP_1.1 %>% 
  ...
  mutate(ID = as.factor(ID),
         Timepoint = rep(c(1,2), times = nrow(PP_5.5)))

save(PP_1.1_ts, file = "Time Series Dataframes/k20_PP_1.1_n50_ts.RData")

###

load("Time Series Dataframes/k20_PP_1.1_n50_ts.RData")
...
ggsave("Time Series Dataframes/k20_PP_1.1_n50_Pre-Post_Box_Violin.jpg", plot = Pre_Post_Box_Violin, width = 6, height = 4)
save(Pre_Post_Box_Violin, file = "Time Series Dataframes/k20_PP_1.1_n50_Pre_Post_Box_Violin.RData")
...
ggsave("Time Series Dataframes/k20_PP_1.1_n50_Pre-Post_Box_Violin_Mean+CI.jpg", plot = Pre_Post_Box_Violin_Mean_CI, width = 6, height = 4)
save(Pre_Post_Box_Violin_Mean_CI, file = "Time Series Dataframes/k20_PP_1.1_n50_Pre_Post_Box_Violin_Mean_CI.RData")
```

```{r remedy14, fig.align="center", out.width="75%"}
#knitr::include_graphics("Time Series Dataframes/k20_PP_1.1_n50_Pre-Post_Box_Violin.jpg")
knitr::include_graphics("Time Series Dataframes/k20_PP_1.1_n50_Pre-Post_Box_Violin_Mean+CI.jpg")
```
...
save(PP_5.5_Mean_PC_JK, file = "Jackknife/PP_5.5_Mean_PC_JK_k20_n50.RData")
...
PP_30.30_Mean_PC_JK = PP_30.30 %>% 
  select(ID, Mean_PC_jse, Mean_PC_jbias)
save(PP_30.30_Mean_PC_JK, file = "Jackknife/PP_30.30_Mean_PC_JK_k20_n50.RData")
```

```{r remedy72, message=FALSE, warning=FALSE, fig.align="center", out.width="75%"}
load("Jackknife/PP_5.5_Mean_PC_JK_k20_n50.RData")
load("Jackknife/PP_30.30_Mean_PC_JK_k20_n50.RData")
...
save(PP_5.5_RCI_ind_preSD_JK, file = "Jackknife/PP_5.5_RCI_ind_preSD_JK_k20_n50.RData")
...
PP_30.30_RCI_ind_preSD_JK = PP_30.30 %>% 
  select(ID, RCI_ind_preSD_jse, RCI_ind_preSD_jbias)
save(PP_30.30_RCI_ind_preSD_JK, file = "Jackknife/PP_30.30_RCI_ind_preSD_JK_k20_n50.RData")
```

```{r remedy74, message=FALSE, warning=FALSE, fig.align="center", out.width="75%"}
load("Jackknife/PP_5.5_RCI_ind_preSD_JK_k20_n50.RData")
load("Jackknife/PP_30.30_RCI_ind_preSD_JK_k20_n50.RData")
...
save(PP_5.5_RCI_ind_pooledSD_JK, file = "Jackknife/PP_5.5_RCI_ind_pooledSD_JK_k20_n50.RData")
...
PP_30.30_RCI_ind_pooledSD_JK = PP_30.30 %>% 
  select(ID, RCI_ind_pooledSD_jse, RCI_ind_pooledSD_jbias)
save(PP_30.30_RCI_ind_pooledSD_JK, file = "Jackknife/PP_30.30_RCI_ind_pooledSD_JK_k20_n50.RData")
```

```{r remedy76, message=FALSE, warning=FALSE, fig.align="center", out.width="75%"}
load("Jackknife/PP_5.5_RCI_ind_pooledSD_JK_k20_n50.RData")
load("Jackknife/PP_30.30_RCI_ind_pooledSD_JK_k20_n50.RData")
